...
if($image_id!='')
{
            ...
            if($query)
            {
                ...
                if($query&&mysql_num_rows($query)==1)
                {
                    ...
                    if(!$query)
                    {
                        ...
                        log_error("unlike_image.php: (4): ", mysql_error());
                    }
                }
                else
                {
                   $errors.="Something went wrong. We are working on fixing it";
                   log_error("unlike_image.php: (3): ", mysql_error());
                }
            }
            else
            {
                $errors.="Something went wrong. We are working on fixing it";
                log_error("unlike_image.php: (2): ", mysql_error());
            }
        }
        else
    ...
    {
        $errors.="Something went wrong. We are working on fixing it";
        log_error("unlike_image.php: (1): ", mysql_error());
    }
}
