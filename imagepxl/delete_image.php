...
if($image_id!='')
{
            ...
            if($query)
            {
                ...
                if($query&&mysql_num_rows($query)==1)
                {
                    ...
                    if(!$query)
                    {
                        ...
                        log_error("delete_image.php: (4): ", mysql_error());
                    }
                ...
                {
                    echo "Something went wrong. We are working on fixing it";
                    log_error("delete_image.php: (3): ", mysql_error());
                }
                ...
                if($query&&mysql_num_rows($query)==1)
                {
                    ...
                    {
                        echo "Something went wrong. We are working on fixing it";
                        log_error("delete_image.php: (6): ", mysql_error());
                    }
                ...
                {
                    echo "Something went wrong. We are working on fixing it";
                    log_error("delete_image.php: (5): ", mysql_error());
                }
            }
            else
            {
                echo "Something went wrong. We are working on fixing it";
                log_error("delete_image.php: (2): ", mysql_error());
            }
        }
    }
    else if(!$query)
    {
        echo "Something went wrong. We are working on fixing it";
        log_error("delete_image.php: (1): ", mysql_error());
    }
}
else
