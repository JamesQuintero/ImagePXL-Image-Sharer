...
<html>
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="http://www.imagepxl.com/temp_main.css" />
        <script src="//ajax.googleapis.com/ajax/libs/jquery/2.0.3/jquery.min.js"></script>
        <script src="http://www.imagepxl.com/jquery-ui-1.10.3/ui/jquery-ui.js"></script>
        <script type="text/javascript" src="http://www.imagepxl.com/all_jquery.js"></script>
         ...
         function display_albums()
         {
             ...
             }, function(output)
             {
                ...
                $('#images').html("<table><tbody>"+row_html+"</tbody></table>");
                 ...
                 for(var x = 0; x < album_ids.length; x++)
                 {
                     var album_info="<a class='link title_color' href='http://imagepxl.com/album/"+album_ids[x]+"' ><span class='title_color'>"+album_names[x]+"</span></a><span class='text_color' > ("+num_images[x]+" images)</span>";
                                                                      ...
                                                                      <table style="float:right;">
                                                                          <tbody>
                                                                              <tr>
                                                                                 ...
                                                                                 <td>
                                                                                     <span class="profile_stat_numbers"><?php echo $num_followers ?></span>
                                                                                 </td>
                                                                             </tr>
                                                                             <tr>
                                                                                 <td>
                                                                                 ...
                                                                                 <td>
                                                                                     <span class="profile_stat_numbers"><?php echo $image_views ?></span>
                                                                                 </td>
                                                                             </tr>
                                                                              <tr>
                                                                                 <td>
                                                                                 ...
                                                                                 <td>
                                                                                     <span class="profile_stat_numbers"><?php echo $profile_views; ?></span>
                                                                                 </td>
                                                                             </tr>
                                                                             <tr>
                                                                                 <td>
                                                                                 ...
                                                                                 <td>
                                                                                     <span class="profile_stat_numbers"><?php echo $num_images; ?></span>
                                                                                 </td>
                                                                             </tr>
                                                                              <tr>
                                                                                  <td>
                                                                                  ...
                                                                                  <td>
                                                                                      <span class="profile_stat_numbers"><?php echo get_time_since((int)($last_sign_in),0); ?></span>
                                                                                  </td>
                                                                              </tr>
                                                                              <tr>
                                                                                  <td>
                                                                                  ...
                                                                                  <td>
                                                                                      <span class="profile_stat_numbers"><?php echo get_time_since((int)($date_joined), 0); ?></span>
                                                                                  </td>
                                                                              </tr>
                                                                          </tbody>
                                                                      </table>
